        ...
        private void InitializeEverything() {
            try {
                ...
                if (_clientState.IsLoggedIn && !config.NpcSpeechGenerationDisabled) {
                    ...
                    _chat.PrintError("[Artemis Roleplaying Kit] Warning: There are two days left to generate new dialogue until May 9th. We're asking the community to try and play through any quests or content they wouldn't normally play through before the remaining character budget expires.");
                }
